...
import com.mxgraph.examples.swing.editor.EditorActions.PropertiesAction;
...
public class EditorPopupMenu extends JPopupMenu {
	...
	public EditorPopupMenu(BasicGraphEditor editor) {
		...
		add(editor.bind(mxResources.get("properties"), new PropertiesAction())).setEnabled(selected);
